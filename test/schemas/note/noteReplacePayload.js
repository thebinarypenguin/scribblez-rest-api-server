...
lab.experiment('noteReplacePayload schema', () => {
  ...
  lab.experiment('body', () => {
    ...
    lab.test('is required', (done) => {
      ...
      Code.expect(Joi.assert.bind(this, good, server.plugins.schemas.noteReplacePayload)).to.not.throw();
      Code.expect(Joi.assert.bind(this, bad, server.plugins.schemas.noteReplacePayload)).to.throw();
